...
set_property -name "webtalk.xsim_launch_sim" -value "389" -objects $obj
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/../../IP_sincos"]" $obj
...
set file "$origin_dir/src/blockdesign/design_1.bd"
